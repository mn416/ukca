...
full_chunk_x = ukca_config%i_ukca_asad_full_chunk_size(1)
full_chunk_y = ukca_config%i_ukca_asad_full_chunk_size(2)
full_chunk_z = ukca_config%i_ukca_asad_full_chunk_size(3)
